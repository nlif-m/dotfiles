...
myKeys =
    ...
    -- Run Prompt
        , ("M-d", spawn "dmenu_run -i ") -- Dmenu
        , ("M-S-d", spawn "passmenu")

        -- Useful programs to have a keybinding for launch
        , ("M-S-<Return>", spawn (myTerminal))
        , ("M-<F1>",         spawn "pandoc --from markdown --to pdf ~/.xmonad/xmonad.md | zathura -")
        ...
        , ("M-<F10>",         spawn (myTerminal ++ " -e slock systemctl suspend -i"))
        , ("M-<F12>",         spawn (myTerminal ++ " -e shutdown now"))
